...
type MailServiceClient interface {
	SingleMailRPC(ctx context.Context, in *SingleMailRequest, opts ...grpc.CallOption) (*SingleMailResponse, error)
}
...
func (c *mailServiceClient) SingleMailRPC(ctx context.Context, in *SingleMailRequest, opts ...grpc.CallOption) (*SingleMailResponse, error) {
	out := new(SingleMailResponse)
	err := c.cc.Invoke(ctx, "/rpcs.MailService/SingleMailRPC", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type MailServiceServer interface {
	SingleMailRPC(context.Context, *SingleMailRequest) (*SingleMailResponse, error)
...
func (UnimplementedMailServiceServer) SingleMailRPC(context.Context, *SingleMailRequest) (*SingleMailResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SingleMailRPC not implemented")
}
...
func _MailService_SingleMailRPC_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SingleMailRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(MailServiceServer).SingleMailRPC(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/rpcs.MailService/SingleMailRPC",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(MailServiceServer).SingleMailRPC(ctx, req.(*SingleMailRequest))
	}
...
var MailService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "rpcs.MailService",
	HandlerType: (*MailServiceServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "SingleMailRPC",
			Handler:    _MailService_SingleMailRPC_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "messaging/mail.proto",
}
